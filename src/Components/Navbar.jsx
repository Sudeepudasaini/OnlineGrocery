...
<img className="h-20" src={logo1} alt="logo1" />
    ...
    <div className="hidden sm:flex items-center gap-8">
        ...
        <button className="cursor-pointer px-8 py-2 bg-[var(--color-primary)]  hover:bg-[var(--color-primary-dull)] transition text-white rounded-full">
            Login
        </button>
    </div>
    ...
    <div className={`${open ? 'flex' : 'hidden'} absolute top-[60px] left-0 w-full bg-white shadow-md py-4 flex-col items-start gap-2 px-5 text-sm md:hidden`}>
        ...
        <button className="cursor-pointer px-6 py-2 mt-2 bg-[var(--color-primary)] hover:bg-[var(--color-primary-dull)] transition text-white rounded-full text-sm">
            Login
        </button>
    </div>
